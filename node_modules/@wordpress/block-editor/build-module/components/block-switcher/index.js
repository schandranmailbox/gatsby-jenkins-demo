...
import { switchToBlockType, store as blocksStore, isReusableBlock } from '@wordpress/blocks';
...
export var BlockSwitcherDropdownMenu = function BlockSwitcherDropdownMenu(_ref) {
  ...
  var _useSelect = useSelect(function (select) {
    ...
    if (_isSingleBlockSelected) {
      ...
      reusableBlockTitle = isReusableBlock(blocks[0]) && __experimentalGetReusableBlockTitle(blocks[0].attributes.ref);
    } else {
      var _getBlockType;
  ...
  var blockSwitcherDescription = 1 === blocks.length ? __('Change block type or style') : sprintf(
