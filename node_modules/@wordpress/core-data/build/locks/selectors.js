...
function __unstableIsLockAvailable(state, store, path, _ref) {
  ...
  var _iterator = _createForOfIteratorHelper((0, _utils.iteratePath)(locks, storePath)),
      _step;
  ...
  var node = (0, _utils.getNode)(locks, storePath);
  ...
  var _iterator2 = _createForOfIteratorHelper((0, _utils.iterateDescendants)(node)),
      _step2;
