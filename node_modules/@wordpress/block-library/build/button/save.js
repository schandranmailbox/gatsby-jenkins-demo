...
function save(_ref) {
  ...
  var buttonClasses = (0, _classnames2.default)('wp-block-button__link', colorProps.className, {
  ...
  var wrapperClasses = (0, _classnames2.default)(className, (0, _defineProperty2.default)({}, "has-custom-width wp-block-button__width-".concat(width), width));
