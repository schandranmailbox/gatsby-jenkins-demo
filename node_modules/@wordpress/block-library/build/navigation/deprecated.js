...
var _default = [{
  ...
  isEligible: function isEligible(attributes) {
    ...
    for (var styleAttribute in TYPOGRAPHY_PRESET_DEPRECATION_MAP) {
      var attributeValue = attributes.style.typography[styleAttribute];
  ...
  migrate: function migrate(attributes) {
    return _objectSpread(_objectSpread({}, attributes), {}, {
      style: _objectSpread(_objectSpread({}, attributes.style), {}, {
        typography: (0, _lodash.mapValues)(attributes.style.typography, function (value, key) {
          var prefix = TYPOGRAPHY_PRESET_DEPRECATION_MAP[key];

          if (prefix && value.startsWith(prefix)) {
            var newValue = value.slice(prefix.length);
