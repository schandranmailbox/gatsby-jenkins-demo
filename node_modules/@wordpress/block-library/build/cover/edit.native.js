...
var Cover = function Cover(_ref) {
  ...
  var _useState3 = (0, _element.useState)(false),
      ...
      isUploadInProgress = _useState4[0],
      setIsUploadInProgress = _useState4[1]; // initialize upload failure flag to true if url is local


  var _useState5 = (0, _element.useState)(id && (0, _url.getProtocol)(url) === 'file:'),
      _useState6 = (0, _slicedToArray2.default)(_useState5, 2),
      didUploadFail = _useState6[0],
      setDidUploadFail = _useState6[1]; // don't show failure if upload is in progress
  ...
  var _useState7 = (0, _element.useState)(true),
      ...
      isVideoLoading = _useState8[0],
      setIsVideoLoading = _useState8[1];
  ...
  var onClearMedia = (0, _element.useCallback)(function () {
    setAttributes({
      id: undefined,
      url: undefined
    });
  ...
  var onBottomSheetClosed = (0, _element.useCallback)(function () {
...
var _default = (0, _compose.compose)([(0, _blockEditor.withColors)({
...
}), (0, _data.withDispatch)(function (dispatch, _ref7) {
  ...
  var _dispatch2 = dispatch('core/block-editor'),
      _selectBlock = _dispatch2.selectBlock;
