...
import { Button, ButtonGroup, KeyboardShortcuts, PanelBody, RangeControl, TextControl, ToggleControl, ToolbarButton, ToolbarGroup, Popover } from '@wordpress/components';
...
function WidthPanel(_ref2) {
  var selectedWidth = _ref2.selectedWidth,
...
function URLPicker(_ref3) {
  ...
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(ToolbarGroup, null, !urlIsSet && createElement(ToolbarButton, {
    ...
    bindGlobal: true,
    shortcuts: (_ref5 = {}, _defineProperty(_ref5, rawShortcut.primary('k'), openLinkControl), _defineProperty(_ref5, rawShortcut.primaryShift('k'), unlinkButton), _ref5)
  }), linkControl);
}
...
function ButtonEdit(props) {
  ...
  return createElement(Fragment, null, createElement(ColorEdit, props), createElement("div", _extends({}, blockProps, {
    className: classnames(blockProps.className, _defineProperty({}, "has-custom-width wp-block-button__width-".concat(width), width))
