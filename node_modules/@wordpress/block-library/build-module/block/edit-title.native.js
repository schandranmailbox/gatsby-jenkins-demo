...
function EditTitle(_ref) {
  var getStylesFromColorScheme = _ref.getStylesFromColorScheme,
      title = _ref.title;
  var lockIconStyle = getStylesFromColorScheme(styles.lockIcon, styles.lockIconDark);
  var titleStyle = getStylesFromColorScheme(styles.title, styles.titleDark);
  var infoIconStyle = getStylesFromColorScheme(styles.infoIcon, styles.infoIconDark);
