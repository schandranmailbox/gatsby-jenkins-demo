...
import { BlockAlignmentToolbar, BlockControls, BlockIcon, MediaPlaceholder, useBlockProps } from '@wordpress/block-editor';
...
export function ImageEdit(_ref) {
  ...
  return createElement(Fragment, null, controls, createElement("figure", blockProps, url && createElement(Image, {
