...
var MIN_WIDTH = (_styles$columnsContai = styles.columnsContainer) === null || _styles$columnsContai === void 0 ? void 0 : _styles$columnsContai.minWidth;
/**
...
var MARGIN = (_styles$columnsContai2 = styles.columnsContainer) === null || _styles$columnsContai2 === void 0 ? void 0 : _styles$columnsContai2.marginLeft;
export var getColumnsInRow = function getColumnsInRow(width, columnCount) {
  if (width) {
...
export var calculateContainerWidth = function calculateContainerWidth(containerWidth, columnsInRow) {
  return 2 * MARGIN + containerWidth - columnsInRow * 2 * MARGIN;
};
export var getContentWidths = function getContentWidths(columnsInRow, width, columnCount, innerColumns, globalStyles) {
  var widths = {};
  var columnWidthsWithUnits = getWidths(innerColumns, false);
  var columnWidths = getColumnWidths(innerColumns, columnCount); // Array of column width attribute values
  ...
  innerColumns.forEach(function (_ref) {
    ...
    var attributeWidth = convertUnitToMobile({
      width: width
