...
var PLACEHOLDER_PHRASES = {
  ...
  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  3: __('The following changes have been made to your %1$s, %2$s, and %3$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  4: __('The following changes have been made to your %1$s, %2$s, %3$s, and %4$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  5: __('The following changes have been made to your %1$s, %2$s, %3$s, %4$s, and %5$s.')
};
...
function EntitiesSavedStates(_ref) {
  ...
  __('The following changes have been made to multiple entities.'); // eslint-disable-next-line @wordpress/valid-sprintf
  ...
  }, createElement("strong", null, __('Are you ready to save?')), createElement("p", null, promptPhrase)), partitionedSavables.map(function (list) {
