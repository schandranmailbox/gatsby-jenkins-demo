...
var PLACEHOLDER_PHRASES = {
  ...
  1: (0, _i18n.__)('The following changes have been made to your %s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  2: (0, _i18n.__)('The following changes have been made to your %1$s and %2$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  3: (0, _i18n.__)('The following changes have been made to your %1$s, %2$s, and %3$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  4: (0, _i18n.__)('The following changes have been made to your %1$s, %2$s, %3$s, and %4$s.'),

  /* translators: placeholders represent pre-translated singular/plural entity names (page, post, template, site, etc.) */
  5: (0, _i18n.__)('The following changes have been made to your %1$s, %2$s, %3$s, %4$s, and %5$s.')
};
...
function EntitiesSavedStates(_ref) {
  ...
  (0, _i18n.__)('The following changes have been made to multiple entities.'); // eslint-disable-next-line @wordpress/valid-sprintf
  ...
  }, (0, _element.createElement)("strong", null, (0, _i18n.__)('Are you ready to save?')), (0, _element.createElement)("p", null, promptPhrase)), partitionedSavables.map(function (list) {
