...
function createBlock(name) {
  ...
  var sanitizedAttributes = (0, _utils.sanitizeBlockAttributes)(name, attributes);
...
function cloneBlock(block) {
  ...
  var sanitizedAttributes = (0, _utils.sanitizeBlockAttributes)(block.name, _objectSpread(_objectSpread({}, block.attributes), mergeAttributes));
