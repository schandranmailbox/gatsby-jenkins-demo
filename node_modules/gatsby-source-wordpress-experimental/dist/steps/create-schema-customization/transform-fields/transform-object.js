...
const buildGatsbyNodeObjectResolver = ({
  ...
  if ( // only fetch/create nodes in resolvers for media items
  (queryInfo.nodesTypeName !== `MediaItem` || // and only when they have lazyNodes enabled
  !queryInfo.settings.lazyNodes) && // but if we're in preview mode we want to lazy fetch nodes
